fn main(){
    ...
    println!("1. Distinguish between computegr and computer programming,/n
              ...
              5. Navigate the career prospects in compter science,/n
              6. Conversant with compter programming concepts.")
}